...
export default function Footer() {
  return (
    <footer className="bg-ink text-footer-text">
      <div className="mx-auto max-w-shell px-10 pb-10 pt-16">
        <div className="grid grid-cols-1 gap-10 border-b border-footer-divider pb-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <p className="mb-1.5 font-serif text-[26px] font-semibold tracking-[0.04em] text-surface">
              MERIDIAN
            </p>
            <p className="mb-5 text-[9px] font-medium uppercase tracking-[0.34em] text-muted">
              Modern &amp; Contemporary
            </p>
...
function FooterCol({ title, children }) {
  return (
    <div>
      <p className="mb-[18px] text-[10px] font-medium uppercase tracking-[0.2em] text-muted">{title}</p>
